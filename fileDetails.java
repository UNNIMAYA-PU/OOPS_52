...
class fileDetails
{
  public static void main(String args[])
   {
    File f1=new File("C:\\Users\\unnimaya\\Desktop\\unniz\\java\\packages");
    if (f1.isDirectory())
     {
       ...
       for(int i=0;i<s.length;i++)
        {
           File f2=new File("C:\\Users\\unnimaya\\Desktop\\unniz\\java\\packages"+"\\"+s[i]);
           if (f2.isDirectory())
       ...
       System.out.println("C:\\Users\\unnimaya\\Desktop\\unniz\\java\\packages"+" is not a directory");
     ...
     for(int i=0;i<filelist.length;i++)
      {
        File f2=new File("C:\\Users\\unnimaya\\Desktop\\unniz\\java\\packages"+"//"+filelist[i]);
...
/* output:
>java fileDetails
Details of :C:\Users\unnimaya\Desktop\unniz\java\packages
Total No.of files :6
